...
for root, _, files in os.walk(directory):
    for file in files:
        if file.endswith('.html'):
            ...
            content = re.sub(r'style\.css\?v=\d+', 'style.css?v=241', content)
            # Replace script_v105.js?v=XXX
            content = re.sub(r'script_v105\.js\?v=\d+', 'script_v105.js?v=241', content)
            # Replace script.js?v=XXX
            content = re.sub(r'script\.js\?v=\d+', 'script.js?v=241', content)
